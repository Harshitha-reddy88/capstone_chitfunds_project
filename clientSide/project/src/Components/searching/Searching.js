                            ...
                            <div>
                                <div className="searchingDiv auction">
                                    <div className="childDiv">
                                        <h1 className="serchingMainHeading">AUCTION CHITI</h1>
                                        <img className="searchingImg" src={image1} alt={details1} />
                                    ...
                                    <div className='processMainDiv'>
                                        <div className="processDiv">
                                            <div className="childProcess">
                                                <img className="process gapBack"src="../resourses/registration.jpg" alt=""/>
                                                <div className='serchingName'>
                                            ...
                                            <div className="childProcess">
                                                <img className="process gapBack" src="../resourses/bidding.jpg" alt=""/>
                                                <div className='serchingName'>
                                            ...
                                            <div className="childProcess">
                                                <img className="process gapBack" src="../resourses/contribution.jpg" alt=""/>
                                                <div className='serchingName'>
                                            ...
                                            <div className="childProcess">
                                                <img className="closeProcess gapBack" src="../resourses/close.jpg" alt=""/>
                                                <div className='serchingName'>
                                    ...
                                    <div>
                                        <button className="serchexploreBtn" onClick={displayIframe}>Explore Auction Chit</button>
                                    </div>
                                ...
                                <div className="searchingDiv">
                                    <div className="childDiv">
                                        <h1 className="serchingMainHeading">AGENT CHITI</h1>
                                        <img className="searchingImg" src={image2} alt={details2} />
                                    ...
                                    <div className='processMainDiv'>
                                        <div className="processDiv">
                                            <div className="childProcess">
                                                <img className="process gapBack"src="../resourses/registor.jpg" alt=""/>
                                                <div className='serchingName'>
                                                    <h2 className="serchingHeading">Registration</h2>
                                                </div>  
                                            </div>
                                            ...
                                            <div className="childProcess">
                                                <img className="process gapBack" src="../resourses/managing.jpg" alt=""/>
                                                <div className='serchingName'>
                                            ...
                                            <div className="childProcess">
                                                <img className="process gapBack" src="../resourses/distribution.jpg" alt=""/>
                                                <div className='serchingName'>
                                            ...
                                            <div className="childProcess">
                                                <img className="process gapBack" src="../resourses/dataEntry.jpg" alt=""/>
                                                <div className='serchingName'>
                                    ...
                                    <div>
                                        <button className="serchexploreBtn" onClick={displayIframe1}>Explore Agent Chit</button>
                                    </div>
                                ...
                                <div className="searchingDiv">
                                    <div className="childDiv">
                                        <h1 className="serchingMainHeading">DOUBLE CHITI</h1>
                                        <img className="searchingImg"src={image3} alt={details3} />
                                    ...
                                    <div className='processMainDiv'>
                                        <div className="processDiv">
                                            <div className="childProcess">
                                                <img className="process gapBack"src="../resourses/group.jpg" alt=""/>
                                                <div className='serchingName'>
                                            ...
                                            <div className="childProcess">
                                                <img className="process gapBack" src="../resourses/agrement.jpg" alt=""/>
                                                <div className='serchingName'>
                                                    <h2 className="serchingHeading">Agrement</h2>
                                                </div>
                                            ...
                                            <div className="childProcess">
                                                <img className="process gapBack" src="../resourses/contribution1.jpg" alt=""/>
                                                <div className='serchingName'>
                                                    <h2 className="serchingHeading">Contribution</h2>
                                                </div>
                                            </div>
                                            ...
                                            <div className="childProcess">
                                                <img className="process gapBack" src="../resourses/incoming.jpg" alt=""/>
                                                <div className='serchingName'>
                                    ...
                                    <div>
                                        <button className="serchexploreBtn" onClick={displayIframe2}>Explore Double Chit</button>
                                    </div>
